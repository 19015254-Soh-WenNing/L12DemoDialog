package sg.edu.rp.c346.id19015254.demodialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEx3.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                final EditText etNo1 = viewDialog.findViewById(R.id.editTextInput2);
                final EditText etNo2 = viewDialog.findViewById(R.id.editTextInput3);
